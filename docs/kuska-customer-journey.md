...
## Introducción: El Viaje de Inmunización Cognitiva

El **Customer Journey Map** de KUSKA Lab ha sido diseñado bajo los principios de la **Inoculación Cognitiva Activa** (Prebunking) y la **Pedagogía Socio-constructivista** [911, 912]. A diferencia de los modelos formativos lineales que asumen una recepción pasiva del conocimiento [911], KUSKA traza un viaje de transformación en tres etapas integradas de forma **figital** (físico-digital) con cero fricción de entrada, donde el usuario pasa de ser un consumidor vulnerable a un creador ético y protector de su comunidad [912, 913, 931].

Este mapa de experiencia sigue a tres arquetipos de usuarios peruanos a través de las tres fases del ecosistema, detallando sus acciones, emociones, barreras, competencias adquiridas y el bucle de retención a largo plazo [677, 912, 913].

---

## 1. Arquetipos de Usuario (Target Personas)

Para ilustrar de forma empática y realista el impacto del ecosistema KUSKA en el Perú actual, el journey sigue el recorrido de tres personajes clave de nuestro público objetivo intergeneracional [677]:

```
   ┌────────────────────────────────────────────────────────┐
   │                  ARQUETIPOS KUSKA                      │
   ├───────────────────┬──────────────────┬─────────────────┤
   │   Sofía (15)      │   Mateo (19)     │  Doña Rosa (65) │
   │   Estudiante Sec. │  Universitario   │ Vecina Jubilada │
   │  Infoxicada/Redes │  Emprendedor/IA  │  Miedo Estafas  │
   └───────────────────┴──────────────────┴─────────────────┘
```

### Arquetipo A: Sofía (15 años) - La Estudiante Navegante
*   **Perfil:** Estudiante de 4to de secundaria de una escuela pública en Lima Metropolitana [677, 693]. Usa intensamente TikTok, Instagram y WhatsApp en su celular para entretenerse y socializar [677, 693].
*   **Dolor/Fricción:** Sufre altos niveles de estrés y ansiedad debido al consumo inconsciente de contenidos polarizados y clickbait algorítmico [677, 693]. Teme ser víctima de ciberacoso mediante manipulación de fotos (deepfakes íntimos) en el colegio [677].
*   **Aspiración:** Usar las tecnologías digitales con confianza, divertirse sin sobrecarga cognitiva y participar activamente con sus compañeros [693, 912].

### Arquetipo B: Mateo (19 años) - El Universitario Emprendedor
*   **Perfil:** Estudiante de Ingeniería Comercial en la Universidad de Lima y micro-emprendedor aficionado, ayudando a su familia en su negocio de confecciones en Gamarra [682, 693].
*   **Dolor/Fricción:** Utiliza ChatGPT y Gemini de forma irresponsable como "muleta cognitiva" para redactar contratos rápidos, arriesgando la privacidad de sus clientes (fuga de datos) [693, 700]. Teme ser estafado mediante falsos comprobantes de Yape/Plin o suplantaciones de voz en el emporio comercial [682, 693].
*   **Aspiración:** Optimizar la productividad de su negocio de forma segura y ética, dominando el prompting estructurado de IA [693, 708].

### Arquetipo C: Doña Rosa (65 años) - La Líder Comunitaria
*   **Perfil:** Vecina jubilada, participante muy activa en la Casa del Adulto Mayor de Chorrillos y coordinadora de la Junta Vecinal de su cuadra [682, 693, 938].
*   **Dolor/Fricción:** Tiene hábitos informativos analógicos y un profundo miedo a ser extorsionada mediante llamadas de WhatsApp que imitan la voz de sus nietos [682, 693]. Siente ansiedad y "cringe" cuando los programas del Estado intentan enseñarle tecnología usando glosarios teóricos complejos [693, 911].
*   **Aspiración:** Proteger la tranquilidad económica de su familia y mantenerse comunicada en redes sin caer en trampas digitales [682, 693].

---

## 2. Mapa del Viaje del Usuario (Customer Journey Map)

A continuación, se desglosa el Customer Journey Map a lo largo de las tres fases del ecosistema KUSKA, estructurado fase a fase:

---

### ESTADIO I: EL RADAR DEL INSTINTO (Fase 1 - KUSKA Check)
...
*   **Mateo (Universitario):** Está esperando su pedido de café en los alrededores del campus de la Universidad de Lima [914]. Al recibir el vaso caliente, nota que la manga protectora de papel Kraft tiene impreso en tipografía marrón chocolate: *“Antes de tu primer sorbo: ¿este comprobante de Yape es real o una alucinación sintética? Pruébalo en 10 segundos”* junto a un código QR minimalista [914]. Mateo escanea el código por curiosidad mientras espera [914].
*   **Sofía (Estudiante):** Ve un filtro interactivo de Realidad Aumentada (WebAR) en TikTok compartido por su mejor amiga [915]. El filtro la invita al reto de descarte *"¿Sobrevivirías la pandemIA?"* [911, 915]. Decide probar el juego desde su cuenta para superar la puntuación de su amiga [915].
*   **Doña Rosa (Adulto Mayor):** Acompañada de su nieta en el paradero del Metropolitano, observa un cartel minimalista en blanco hueso que muestra dos retratos idénticos lado a lado con el texto: *“Una de estas fotos es una identidad falsa creada por IA. El 80% falla. Escanea para probar tu instinto”* [698, 910]. Intrigada y con la ayuda de su nieta, escanea el QR [693].

#### B. Estado Cognitivo y Afectivo
*   **Emociones iniciales:** Curiosidad intelectual, sentido de reto personal, entretenimiento ágil, baja resistencia (no hay sensación de "tarea escolar" u obligación) [912].
*   **Pensamientos del usuario:** *“¿De verdad la IA me puede engañar tan fácil?”*, *“A ver qué tan bueno es mi instinto digital en 60 segundos”*.

#### C. Competencias MIL de la UNESCO Practicadas (Saber Dudar)
*   **Lectura lateral rápida y deconstrucción de la procedencia:** El usuario interactúa mediante **Swipe táctil** (izquierda = IA/Inseguro, derecha = Real/Seguro) enfrentándose a 5 estímulos cotidianos del Perú [917]:
    1.  *Mateo* analiza un prompt conteniendo DNI de clientes y se da cuenta del peligro de fuga de datos en ChatGPT, deslizando a la izquierda (Inseguro) [918].
    2.  *Doña Rosa* se enfrenta a un audio que clona la voz de su nieta pidiendo un Yape urgente de S/. 500 y nota la falta de ruidos de fondo naturales de Lima, deslizando a la izquierda (IA/Suplantación) [697, 917].
    3.  *Sofía* observa un comprobante de Plin para recoger ropa en Gamarra con números desalineados de forma pixelada, deslizando a la izquierda (Fraude/IA) [744].

#### D. Barreras de Experiencia (Frictions) y Mitigación de KUSKA
*   **Fricción:** El usuario suele abandonar los cuestionarios extensos o teme descargar aplicaciones que consumen datos [612, 913].
...
```
       DIAGNÓSTICO (FASE 1)               PARTIDA DE CARTAS CO-OP              KUSKA LOOP
┌───────────────────────────────┐     ┌──────────────────────────────┐     ┌────────────────┐
│ Receta Médica / Pase Figital  ├────►│ Síntoma ➔ Herramienta ➔Acción│├────►│ Cripto-Retícula│
│  Acceso a la Versión Impresa  │     │ Roles: Auditor, Forense, Arq.│     │ Encaja y Abre  │
└───────────────────────────────┘     └──────────────────────────────┘     └────────────────┘
```
...
*   **Pensamientos del usuario:** *“No es un manual aburrido, las cartas físicas me enseñan el paso a paso”*, *“Al fin entiendo cómo se configuran las restricciones de la IA sin que sea física espacial”* [931].

#### C. Competencias MIL de la UNESCO Practicadas (Saber Usar y Convivir)
*   **Uso y creación responsable de la IA:** Los usuarios asumen **Roles de Juego socráticos** (Auditor, Forense y Arquitecto) para debatir sobre un Síntoma (Cereza) expuesto en la mesa [751].
*   *Doña Rosa* (Forense) busca la carta de herramienta **H-02 (Pausa de Confirmación Directa)** ante una llamada sospechosa de su nieta [941].
*   *Sofía* (Auditor) deconstruye la emoción de urgencia artificial alegada en el síntoma [751, 940].
*   *Mateo* (Arquitecto) practica con la carta **A-03 (Configuración Zero-Data)**, aprendiendo a anonimizar sus balances comerciales reemplazando nombres por variables ficticias antes de subirlos a ChatGPT para redactar correspondencia comercial [708, 749].

#### D. Barreras de Experiencia (Frictions) y Mitigación de KUSKA
*   **Fricción:** Exceso de reglas complejas que aburren a los escolares o causan confusión visual en los adultos mayores [138, 618].
...
## 3. Matriz General de Touchpoints y Experiencia Figital
...
## 4. Alineación Teórica y Científica del Journey (Por qué funciona)

Para garantizar la solidez y coherencia metodológica de la postulación técnica ante el comité de jueces de la UNESCO en Grecia, cada punto de contacto del viaje de KUSKA está respaldado científicamente por pilares psicopedagógicos de primer nivel [718, 910]:
